...
namespace EventStore.ClientAPI {
	...
	public interface IEventStoreConnection : IDisposable {
		...
		/// <summary>
		/// Asynchronously reads all events in the node forward (e.g. beginning to end). Filters events based upon the eventFilter.
		/// </summary>
		/// <param name="position">The position to start reading from.</param>
		/// <param name="maxCount">The maximum count to read.</param>
		/// <param name="resolveLinkTos">Whether to resolve LinkTo events automatically.</param>
		...
		/// <summary>
		/// Asynchronously reads all events in the node backwards (e.g. end to beginning). Filters events based upon the eventFilter.
		/// </summary>
		/// <param name="position">The position to start reading from.</param>
		/// <param name="maxCount">The maximum count to read.</param>
		/// <param name="resolveLinkTos">Whether to resolve LinkTo events automatically.</param>
